...
const std::vector<std::string> STOCK_SYMBOLS = {
    ...
    "V", "UNH", "PG", "HD", "DIS", "MA", "PYPL", "BAC", "VZ", "ADBE",
    "CRM", "NFLX", "CMCSA", "XOM", "PFE", "NKE", "INTC", "T", "KO", "MRK",
    "PEP", "ABT", "WMT", "CVX", "CSCO", "MCD", "ABBV", "MDT", "BMY", "ACN",
    "AVGO", "TXN", "COST", "NEE", "QCOM", "DHR", "LIN", "PM", "UNP", "LOW",
    "HON", "UPS", "ORCL", "IBM", "SBUX", "MMM", "GE", "CAT", "BA", "GS",
    "C", "WFC", "USB", "MS", "RTX", "LMT", "BLK", "DE", "ISRG", "TMO",
    "AMGN", "GILD", "CVS", "MO", "AXP", "SPGI", "SYK", "CI", "ELV", "PLD",
    "ZTS", "ADP", "MDLZ", "GPN", "CCI", "TGT", "TJX", "BDX", "CL", "DUK",
    "SO", "D", "SLB", "EOG", "COP", "MMC", "ITW", "NSC", "APD", "FDX"
};
...
int main() {
    ...
    thread stats(stats_printer, ref(stats_stop), ref(total_processed), ref(total_trades));
