...
*   **Optimised Bounded Queue:** Uses `std::mutex` and `std::condition_variable` with **conditional notification** (only waking threads when necessary) to minimize system calls and jitter.
