...
// We assume the structure is: root/backend/server.js and root/build/market_data_engine.exe
const exePath = path.join(__dirname, '../build/market_data_engine.exe');
...
const startEngine = () => {
  ...
  childProcess.stdout.on('data', (data) => {
    ...
    // Split by newline in case multiple JSON objects come in one chunk
    ...
    lines.forEach(line => {
      ...
      try {
        ...
        // If it's not JSON (e.g. startup messages or final stats), just log it to console
